...
data_dir = "/home/spsalmon/better_paper_code/mortality_data/human_mortality_data/cohort/converted_death_rates/"
...
for file in data_files:
    if os.path.splitext(os.path.basename(file))[0] not in list_of_countries:
        continue
